...
public class RazorSaveDataBody {
    ...
    public RazorSaveDataBody(String razorpayOrderId, String razorpayPaymentId, String razorpaySignature, Integer payedAmount, String paymentType, String status) {
