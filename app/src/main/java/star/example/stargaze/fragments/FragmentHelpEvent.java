...
import star.example.stargaze.databinding.FragmentHelpEventBinding;
...
public class FragmentHelpEvent extends Fragment implements View.OnClickListener, FAQPresenter.FAQView {
    private FragmentHelpEventBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_help_event, container, false);
    ...
    public void onSuccess(List<FAQResp> faqResp) {
        ...
        for (int i = 0; i < faqResp.size(); i++) {
            if(faqResp.get(i).getCategory().equalsIgnoreCase("Event")) {
