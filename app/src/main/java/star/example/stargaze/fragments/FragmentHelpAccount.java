...
import star.example.stargaze.databinding.FragmentHelpAccountBinding;
...
public class FragmentHelpAccount extends Fragment implements View.OnClickListener, FAQPresenter.FAQView {
    private FragmentHelpAccountBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_help_account, container, false);
...
//
//        String quest [] = {"I am not able to login my account?","Can i Edit my account?","Is my Account is secure ?","How Stargaze use my data","I am not able to login my account?","Can i Edit my account?","Is my Account is secure ?","How Stargaze use my data","I am not able to login my account?","Can i Edit my account?"};
//        for (int i = 0; i < 10; i++) {
//
//            qestions.add(quest[i]);
//        }
//        if(qestions.size()>0){
//            for(int i =0;i<10;i++){
//                listDataChild.put(qestions.get(i),"Please check whether you registered or not, yes your account is secure,and stargaze will not share your data to others!");
//            }
//        }
//
...
//    }
    ...
    public void onSuccess(List<FAQResp> faqResp) {
        ...
        for (int i = 0; i < faqResp.size(); i++) {
            if(faqResp.get(i).getCategory().equalsIgnoreCase("Account")) {
