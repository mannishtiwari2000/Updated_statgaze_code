...
import star.example.stargaze.databinding.FragmentHelpAboutBinding;
...
public class FragmentHelpAbout extends Fragment implements View.OnClickListener, FAQPresenter.FAQView {
    private FragmentHelpAboutBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_help_about, container, false);
    ...
    public void onSuccess(List<FAQResp> faqResp) {
        ...
        for (int i = 0; i < faqResp.size(); i++) {
            if(faqResp.get(i).getCategory().equalsIgnoreCase("About")) {
