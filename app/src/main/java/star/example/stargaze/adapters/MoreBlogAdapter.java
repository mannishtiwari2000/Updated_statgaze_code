...
public class MoreBlogAdapter extends RecyclerView.Adapter<MoreBlogAdapter.BlogViewHolder> {
    private List<BlogResp>data;
    private Context context;
    private OnBlogItemListener listener;

    public MoreBlogAdapter(List<BlogResp> data, Context context, OnBlogItemListener listener) {
        this.data = data;
    ...
    public BlogViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.more_blog_recycler_row,parent,false);
